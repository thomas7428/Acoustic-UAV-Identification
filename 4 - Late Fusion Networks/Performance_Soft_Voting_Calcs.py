...
JSON_WEIGHTS = config.VOTING_WEIGHTS_PATH_STR  # Weights used to make weighted predictions (created during script run).
VOTED_MODELS_SCORES = config.VOTING_FINAL_SCORES_PATH_STR  # Soft voting performance scores output.
...
Accuracy = config.ALL_MODEL_ACC_PATH_STR  # Accuracy results from Validation 2 subset test (to calculate weights).
